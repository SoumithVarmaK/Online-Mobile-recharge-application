...
public class AirtelProviderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airtel_provider);
        ...
        button2399.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(AirtelProviderActivity.this, SelectPaymentMethodActivity.class);
